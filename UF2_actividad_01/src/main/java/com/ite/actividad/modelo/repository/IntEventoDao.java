...
public interface IntEventoDao {
	...
	/**
	 * Método de devuelve una lista con todos los objetos de tipo Evento que estén
	 * activos. Para ello crea una nueva lista llamada listaActivos y una variabe de
	 ...
	 * representan una posible id de un Evento. Lo primero que hace es crear un nuevo
	...
	/**
	 * Método de devuelve una lista con todos los objetos de tipo Evento que estén
	 * destacados. Para ello crea una nueva lista llamada listaDest y una variabe de
	 * tipo int donde llevar la cuenta. Mediante un bucle for va comprobando si la
	 * propiedad Destacado de cada objeto Evento es igual a 's', en caso
	 * afirmativo añade dicho objeto a la lista listaDest y suma uno a la variabe
	 * numérica. Finalmente comprueba si la variable numérica es menor que cero
	 * (querrá decir que no hay ningun evento destacado), en ese caso devuelve null, en
	 * caso contrario (la varible numérica es mayor que cero, hay eventos destacados),
	 * devuelve la listaDest
	 * 
	 * @return una lista con todos los objetos destacados que hay. En caso de que no
	 *         haya ninguno, devueve null
	 */
